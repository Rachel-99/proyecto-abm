...
void loop() {
  ...
  if (DISTANCIA2<20 || DISTANCIA2>100){
      ESTADO = E2;
  }
  ...
  if (DISTANCIA2<100 && ESTADO== E2 && st_carrito == descargado){
      ESTADO = G2;
  }
  if (DISTANCIA2<100 && ESTADO== E1 && st_carrito == cargado){
      ESTADO = G1;
  }

  // IF dedicados a avanzar o retroceder segun el estado el estado que corresponda
  if(ESTADO == G2){
